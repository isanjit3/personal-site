...
export function NavigationBar() {
  return (
    <div className="unselectable shrink-hover flex flex-row ml-auto w-auto items-start select-none">
      <NavigationMenu className="mx-auto max-w-screen-xl">
        <NavigationMenuList className="flex items-center">
          {/* <NavigationMenuItem>
            <Link href="/blog" legacyBehavior passHref>
              <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "text-lg px-4 py-2")}>
                Blog
              </NavigationMenuLink>
            </Link>
          </NavigationMenuItem> */}
          <div className="flex gap-x-5">
            <NavigationMenuItem>
              <div className="flex justify-center w-15 h-15">
                <ModeToggle />
              </div>
            </NavigationMenuItem>
            <NavigationMenuItem>
