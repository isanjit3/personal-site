...
export default function Home() {
  ...
  return (
    <div className="fade-in transition-all duration-500 ease-in-out">
      <main
        className={`relative flex flex-col items-center justify-center h-screen p-8 transition-all duration-500 ease-in-out ${
          isLightMode ? "bg-lightBackground text-customGray" : "bg-darkBackground text-white"
        }`}
      >
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 w-full unselectable">
            ...
            <a
              ...
              target="_blank"
              className={`w-full sm:w-auto bg-red-500 text-white font-bold py-3 px-6 rounded transition duration-300 ease-in-out group ${
                isLightMode
            ...
            <a
              ...
              target="_blank"
              className={`w-full sm:w-auto bg-blue-600 text-white font-bold py-3 px-6 rounded transition duration-300 ease-in-out group ${
                isLightMode
            ...
            <a
              ...
              target="_blank"
              className={`w-full sm:w-auto bg-purple-600 text-white font-bold py-3 px-6 rounded transition duration-300 ease-in-out group ${
                isLightMode
            ...
            <a
              ...
              target="_blank"
              className={`w-full sm:w-auto bg-green-500 text-white font-bold py-3 px-6 rounded transition duration-300 ease-in-out group ${
                isLightMode
